...
contract SimpleBank {
    ...
    event LogWithdrawal(address indexed accountAddress, uint indexed withdrawAmount,
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        ...
        emit LogWithdrawal(addr, withdrawAmount, balances[addr]);
        return balances[addr];
    }
